...
In cases where YOLOv8, and ultralytics is already cloned and running on a computer it is possible to only swap the plotting.py file found at yolo/utils/plotting.py and the cfg file found at yolo/cfg/default.yaml to enable anonymization, with minimal modification.
